...
t_fb__WorldOcclusionQueryRenderModule__drawBatchQuery           fb__WorldOcclusionQueryRenderModule__drawBatchQuery =           (t_fb__WorldOcclusionQueryRenderModule__drawBatchQuery)0x141A50110; //4C 8B ?? ?? 8B ?? 48 8B ?? 49 8B ?? E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? CC
...
t_fb__WorldOcclusionQueryRenderModule__processBatchQueries      fb__WorldOcclusionQueryRenderModule__processBatchQueries =      (t_fb__WorldOcclusionQueryRenderModule__processBatchQueries)0x141A726B0; //00 00 C6 44 ?? ?? ?? 41 B1 01 49 8B ?? E8
